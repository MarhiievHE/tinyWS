...
const CLOSE_FRAMES = {
  NORMAL_CLOSE: Buffer.from([0x88, 0x02, 0x03, 0xe8]),
  // Going away
  GOING_AWAY: Buffer.from([
    0x88, 0xc, 0x3, 0xe9, 0x47, 0x6f, 0x69, 0x6e, 0x67, 0x20, 0x61, 0x77, 0x61,
    0x79,
  ]),
  PROTOCOL_ERROR: {
    // Unmasked frame from client
    UNMASKED: Buffer.from([
  ...
  INVALID_PAYLOAD: Buffer.from([
    0x88, 0x16, 0x3, 0xef, 0x49, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x20, 0x70,
    0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x20, 0x64, 0x61, 0x74, 0x61,
  ]),
  // Message too big
  MESSAGE_TOO_BIG: Buffer.from([
    0x88, 0x11, 0x3, 0xf1, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x20, 0x74,
